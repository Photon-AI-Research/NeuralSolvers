...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden_size_alpha", type=int, default=200)
    parser.add_argument("--num_hidden_alpha", type=int, default=4)
    ...
    k_values = Variable(0.1*ones([data_info['num_x'],data_info['num_y']]))
    ...
    hpm_loss = pf.HPMLoss.HPMLoss(pde_dataset, derivatives, hpm_model, weight=10.)
