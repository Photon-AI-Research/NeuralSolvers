...
if __name__ == "__main__":
    ...
    for param in hpm_model.alpha_net.parameters():
    ...
    pinn.fit(args.epochs, 'Adam', args.learning_rate, pinn_path='best_model_pinn_iter.pt', hpm_path='best_model_hpm_iter.pt', load_models=False)
    
    # Round 2
    
    hpm_model = pinn.pde_loss.hpm_model
    for param in hpm_model.heat_source_net.parameters():
        param.requires_grad = False
    for param in hpm_model.alpha_net.parameters():
